...
WITH LegalEntity AS
    ...
    SELECT "OwnerAddr", "OwnerName", "OwnerName2", "address_id"
    FROM Qry
    GROUP BY "OwnerAddr", "OwnerName", "OwnerName2", "address_id"
    ORDER BY "address_id"
    )
INSERT INTO core.legal_entity(legal_entity_address, legal_entity_name, legal_entity_secondary_name, address_id) 
SELECT "OwnerAddr", "OwnerName", "OwnerName2", "address_id" 
FROM LegalEntity 
GROUP BY "OwnerAddr", "OwnerName", "OwnerName2", "address_id";