...
SET "removed_flag" = FALSE 
	...
	IN (SELECT "unit"."unit_id"
		...
		JOIN "staging_1"."prcl_bldgse
		ON "county_id_mapping_table"."county_parcel_id" = (SELECT core.format_parcelId(prcl_bldgsect."CityBlock", prcl_bldgsect."Parcel", prcl_bldgsect."OwnerCodct"e"))
